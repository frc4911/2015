 ...
 *
 */
public class DriveForTimeWithoutPID extends Command {
    ...
    public DriveForTimeWithoutPID(double x, double y, double time) {
	this.x = x;
	this.y = y;
	this.time = time;
    }
    ...
    protected void execute() {
    	mecanumDriveSystem.drive(x, y, 0.0, (double)sensorSystem.getYawWithCompensation());
    }
