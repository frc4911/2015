...
public class Robot extends SampleRobot {
	...
	public void rotateToAngle(double angle, double time) {
	    int count = 0;
	    double startTime = Timer.getFPGATimestamp();
	    ...
	    currError = angle - currYaw;//[-180 - 180] degrees
	    ...
	    System.out.println("************************************************************************************");
	    System.out.println("*\tFrom " + currYaw +  " degrees to " + angle + "*");
	    System.out.println("************************************************************************************");
	    while(count <= 10
		    && (Timer.getFPGATimestamp() - startTime <= time)
		    && (isAutonomous() && isEnabled())) {
		if(Math.abs(currError) <= 1.5){
	    	    count++;
	    	} else {
	    	    count = 0;
	    	}
	    	...
	    	System.out.println("Angle:\t" + currYaw);
	    	...
	    	lastError = currError;
	    	//Clear Integral When Passed the Goal Heading
	    	if ( currError * lastError < 0.0){
	    	    integration = 0.0;
	    	}
	    	//PID Constants
	    	double kP = 1.0 / 19.0;
	    	...
	    	System.out.println("Time:\t" + (Timer.getFPGATimestamp() - startTime));
	    	System.out.println("==============================================");
	    	//Command Motors
	    	drive(0.0, 0.0, rotation, currYaw);
	    }
	    drive(0.0, 0.0, 0.0, 0.0);
	    System.out.println("Count:\t" + count);
	    System.out.println(Math.abs(currError) >= 1.0);
	    System.out.println((Timer.getFPGATimestamp() - startTime <= time));
	    System.out.println((isAutonomous() && isEnabled()));
	}
